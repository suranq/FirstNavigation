...
/**
 * Created by 马明祥 on 2019/1/28.
 */

public class MyLoadTopicAdapter extends XRecyclerView.Adapter {


    private List<LoadTopic.TopicListBean> mData;
    private final Context mContext;
    private OnItemListener mListener;

    public MyLoadTopicAdapter(List<LoadTopic.TopicListBean> data, Context context) {
        mData = data;
        mContext = context;
    }
    ...
    public void setData(List<LoadTopic.TopicListBean> data) {
        mData.addAll(data);
